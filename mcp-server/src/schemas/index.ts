...
// ============================================================================
// New Node Types Schemas
// ============================================================================

// Sticky Node
export const CreateStickyInputSchema = z.object({
  text: z.string().default("").describe("Text content of the sticky"),
  x: z.number().optional().describe("X position"),
  y: z.number().optional().describe("Y position"),
  fill: FillSchema.optional().describe("Fill color (yellow, blue, green, etc.)"),
  authorVisible: z.boolean().default(true).describe("Show author name"),
  parentId: z.string().optional().describe("Parent frame ID"),
}).strict();

// Section Node
export const CreateSectionInputSchema = z.object({
  name: z.string().default("Section").describe("Section name"),
  x: z.number().optional().describe("X position"),
  y: z.number().optional().describe("Y position"),
  width: z.number().default(500).describe("Section width"),
  height: z.number().default(500).describe("Section height"),
  fill: FillSchema.optional().describe("Fill color"),
  parentId: z.string().optional().describe("Parent node ID"),
}).strict();

export const SetSectionContentsHiddenInputSchema = z.object({
  nodeId: z.string().describe("Section node ID"),
  hidden: z.boolean().describe("Whether to hide contents"),
}).strict();

// Connector Node (FigJam)
export const ConnectorEndpointSchema = z.object({
  endpointNodeId: z.string().optional().describe("Node to connect to"),
  position: z.object({
    x: z.number(),
    y: z.number()
  }).optional().describe("Fixed position if no node"),
  magnet: z.enum(["AUTO", "TOP", "BOTTOM", "LEFT", "RIGHT", "CENTER"]).optional().describe("Magnet position on node"),
});

export const CreateConnectorInputSchema = z.object({
  start: ConnectorEndpointSchema.describe("Start endpoint"),
  end: ConnectorEndpointSchema.describe("End endpoint"),
  connectorLineType: z.enum(["STRAIGHT", "ELBOWED", "CURVED"]).default("ELBOWED").describe("Line type"),
  strokeColor: z.string().optional().describe("Stroke color"),
  strokeWeight: z.number().default(2).describe("Stroke weight"),
  text: z.string().optional().describe("Text label on connector"),
  textBackground: FillSchema.optional().describe("Text background fill"),
}).strict();

export const UpdateConnectorInputSchema = z.object({
  nodeId: z.string().describe("Connector node ID"),
  start: ConnectorEndpointSchema.optional().describe("New start endpoint"),
  end: ConnectorEndpointSchema.optional().describe("New end endpoint"),
  connectorLineType: z.enum(["STRAIGHT", "ELBOWED", "CURVED"]).optional().describe("Line type"),
  text: z.string().optional().describe("Text label"),
}).strict();

// Slice Node
export const CreateSliceInputSchema = z.object({
  name: z.string().default("Slice").describe("Slice name"),
  x: z.number().optional().describe("X position"),
  y: z.number().optional().describe("Y position"),
  width: z.number().default(100).describe("Width"),
  height: z.number().default(100).describe("Height"),
  parentId: z.string().optional().describe("Parent node ID"),
  exportSettings: z.array(z.object({
  ...
  })).optional().describe("Export settings"),
}).strict();

// Code Block Node (FigJam)
export const CreateCodeBlockInputSchema = z.object({
  code: z.string().default("").describe("Code content"),
  language: z.enum([
    "TYPESCRIPT",
    "JAVASCRIPT",
    "PYTHON",
...
export const UpdateCodeBlockInputSchema = z.object({
  nodeId: z.string().describe("Code block node ID"),
...
export const CreateTableInputSchema = z.object({
  name: z.string().default("Table").describe("Table name"),
  rows: z.number().default(3).describe("Number of rows"),
  columns: z.number().default(3).describe("Number of columns"),
  x: z.number().optional().describe("X position"),
  y: z.number().optional().describe("Y position"),
  cellWidth: z.number().default(100).describe("Default cell width"),
  cellHeight: z.number().default(40).describe("Default cell height"),
  parentId: z.string().optional().describe("Parent node ID"),
}).strict();

export const UpdateTableInputSchema = z.object({
  nodeId: z.string().describe("Table node ID"),
  insertRows: z.number().optional().describe("Number of rows to insert"),
  insertColumns: z.number().optional().describe("Number of columns to insert"),
  deleteRows: z.array(z.number()).optional().describe("Row indices to delete"),
  deleteColumns: z.array(z.number()).optional().describe("Column indices to delete"),
}).strict();

export const SetTableCellInputSchema = z.object({
  nodeId: z.string().describe("Table node ID"),
  ...
  fill: FillSchema.optional().describe("Cell fill color"),
}).strict();

// ============================================================================
// Annotations API Schemas (Dev Mode)
// ============================================================================

export const AnnotationPropertySchema = z.object({
  type: z.enum(["width", "height", "x", "y", "rotation", "fill", "stroke", "opacity", "cornerRadius", "custom"]).describe("Property type"),
  customLabel: z.string().optional().describe("Custom label for custom type"),
});

export const CreateAnnotationInputSchema = z.object({
  nodeId: z.string().describe("Node to annotate"),
  label: z.string().describe("Annotation label/note"),
  properties: z.array(AnnotationPropertySchema).optional().describe("Properties to pin"),
}).strict();
...
export const UpdateAnnotationInputSchema = z.object({
  ...
  annotationIndex: z.number().describe("Index of annotation to update"),
  label: z.string().optional().describe("New label"),
  properties: z.array(AnnotationPropertySchema).optional().describe("New properties"),
}).strict();

export const RemoveAnnotationInputSchema = z.object({
  nodeId: z.string().describe("Node ID"),
  annotationIndex: z.number().optional().describe("Index of annotation to remove (removes all if not specified)"),
}).strict();

// Dev Status
export const SetDevStatusInputSchema = z.object({
  nodeId: z.string().describe("Section or frame node ID"),
  status: z.enum(["NONE", "READY_FOR_DEV", "COMPLETED"]).describe("Development status"),
}).strict();
...
// New Node Types
export type CreateStickyInput = z.infer<typeof CreateStickyInputSchema>;
export type CreateSectionInput = z.infer<typeof CreateSectionInputSchema>;
export type SetSectionContentsHiddenInput = z.infer<typeof SetSectionContentsHiddenInputSchema>;
...
export type UpdateCodeBlockInput = z.infer<typeof UpdateCodeBlockInputSchema>;
...
export type SetTableCellInput = z.infer<typeof SetTableCellInputSchema>;

// Annotations API types
export type AnnotationProperty = z.infer<typeof AnnotationPropertySchema>;
...
export type RemoveAnnotationInput = z.infer<typeof RemoveAnnotationInputSchema>;
export type SetDevStatusInput = z.infer<typeof SetDevStatusInputSchema>;
